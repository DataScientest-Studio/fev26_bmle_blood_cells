...
EXPERIMENTS = [
    {"name": "A1_baseline", "phase1_epochs": 5, "phase2_epochs": 10,
     "batch_size": 32, "lr1": 1e-3, "lr2": 1e-4, "activation": "default"},
    {"name": "A2_ep20_b32", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 32, "lr1": 1e-3, "lr2": 1e-4, "activation": "default"},
    {"name": "A3_ep25_b64", "phase1_epochs": 5, "phase2_epochs": 25,
     "batch_size": 64, "lr1": 1e-3, "lr2": 1e-4, "activation": "default"},
    {"name": "A4_ep20_b64", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 64, "lr1": 1e-3, "lr2": 1e-4, "activation": "default"},
    {"name": "B1_lr_prudent", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 32, "lr1": 1e-3, "lr2": 5e-5, "activation": "default"},
    {"name": "B2_lr_mid", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 32, "lr1": 5e-4, "lr2": 1e-4, "activation": "default"},
    {"name": "B3_lr_agg", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 32, "lr1": 1e-3, "lr2": 2e-4, "activation": "default"},
    {"name": "C1_gelu", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 32, "lr1": 1e-3, "lr2": 1e-4, "activation": "gelu"},
    {"name": "C2_silu", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 32, "lr1": 1e-3, "lr2": 1e-4, "activation": "silu"},
    {"name": "C3_mish", "phase1_epochs": 5, "phase2_epochs": 20,
     "batch_size": 32, "lr1": 1e-3, "lr2": 1e-4, "activation": "mish"},
]
